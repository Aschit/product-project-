...
<body>
    ...
    <div class="container" style="margin: 30px 0px; margin-left: 300px;">
        <h2 class= "display-6">Edit a comment:</h2>
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <button type="submit" name="submit" style= "border-radius: 5px; padding: 7px; color: #fff; background-color: brown;">Comment</button>
