        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-6 pl-md-5"data-aos="fade-left">
            ...
            <p class="lead">The Paralympic Games provide a platform for Para athletes with a diverse range of impairments
                        ...
                        viewers</p>
            <p> athletes competing in the Paralympic Games display an unparalleled level of athletic
                        process. They push the boundaries of what is perceived as possible and redefine the
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-6 pr-md-5">
            ...
            <p class="lead"> We believe in the power of sports to inspire and unite people, transcending boundaries
                            and fostering friendship among nations.</p>
          </div>
        </div>
       </div>
     </div> 
